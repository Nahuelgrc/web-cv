// -----------------------------------------------------------------------------
// icons.tsx
// Vector icons as DOM SVG (not @react-pdf). Used on the web page; they mirror
// the icons in pdf/icons.tsx so the page and the PDF look the same.
// -----------------------------------------------------------------------------
...
// Envelope (email)
export function EmailIcon({ size = 12, color = GRAY, style }: IconProps) {
  return (
...
// Location pin
export function LocationIcon({ size = 12, color = GRAY, style }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" style={style}>
      <path
...
// Calendar
export function CalendarIcon({ size = 11, color = GRAY, style }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" style={style}>
...
// LinkedIn
export function LinkedInIcon({ size = 14, color = "#0A66C2", style }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" style={style}>
...
// GitHub
export function GitHubIcon({ size = 14, color = "#181717", style }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" style={style}>
      <path
...
// Stack Overflow
export function StackOverflowIcon({ size = 14, style }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" style={style}>
...
// Selector by platform name (data-driven from the JSON)
export function SocialIcon({ platform, size = 14, style }: IconProps & { platform: string }) {
  const p = (platform || "").toLowerCase();
  if (p.includes("linkedin")) return <LinkedInIcon size={size} style={style} />;
  if (p.includes("github")) return <GitHubIcon size={size} style={style} />;
  if (p.includes("stack")) return <StackOverflowIcon size={size} style={style} />;
